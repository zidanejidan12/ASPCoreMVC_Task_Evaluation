        ...
        public IEnumerable<Article> GetArticlesWithPaging(int pageNumber, int pageSize, string search, int? categoryId = null)
{
    try
    {
        // Call the DAL method with the additional categoryId parameter
        return _articleDAL.GetArticlesWithPaging(pageNumber, pageSize, search, categoryId);
    }
    catch (Exception ex)
    {
        // Log or handle the exception as needed
        throw new Exception("Error in BLL while retrieving paginated articles: " + ex.Message);
    }
}
